...
public class ParllelStreamExample6 {
	...
	public static void main(String[] args) throws IOException {
		...
		ParllelStreamExample6 obj = new ParllelStreamExample6();

		List<Employee> employees = obj.generateEmployee(10000);

//		 normal, sequential
		employees.stream().forEach(ParllelStreamExample6::save); 		  // 27s-29s

//		 parallel
//		employees.parallelStream().forEach(ParllelStreamExample6::save);  // 7s-8s
